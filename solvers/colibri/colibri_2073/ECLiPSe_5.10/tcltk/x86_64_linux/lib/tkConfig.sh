...
# build directory.
TK_BUILD_LIB_SPEC='-L/homes/kish/TclTk/tk8.5.2/unix/x86_64_linux -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/homes/kish/TclTk/x86_64_linux/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/homes/kish/TclTk/include'
...
# compiled.
TK_SRC_DIR='/homes/kish/TclTk/tk8.5.2'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/homes/kish/TclTk/tk8.5.2/unix/x86_64_linux -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/homes/kish/TclTk/x86_64_linux/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/homes/kish/TclTk/tk8.5.2/unix/x86_64_linux/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/homes/kish/TclTk/x86_64_linux/lib/libtkstub8.5.a'
