...
TK_LIBS='-L/usr/X11R6/lib -lX11 -lXss -lXext  -ldl  -lieee -lm'
...
TK_EXEC_PREFIX='/homes/kish/TclTk/i386_linux'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/homes/kish/TclTk/tk8.5.2/unix/i386_linux -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/homes/kish/TclTk/i386_linux/lib -ltk8.5'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/homes/kish/TclTk/tk8.5.2/unix/i386_linux -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/homes/kish/TclTk/i386_linux/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/homes/kish/TclTk/tk8.5.2/unix/i386_linux/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/homes/kish/TclTk/i386_linux/lib/libtkstub8.5.a'
